...
function f() {
	try {
		...
		var name = document.querySelector("#main > header > div._2uaUb > div.z4t2k > div > span").textContent;
		var status = document.querySelector("#main > header > div._2uaUb > div.YmixP.fKfSX > span");
